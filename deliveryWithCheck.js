...
function chooseRole() {
  ...
  function enterPersonalInfo() {
    ...
    person.name = `${firstName || 'no name'} ${lastName || 'no surname'}`;
    ...
    person.phonenumber = userInputPhoneNumber;
...
function adminMain(){
 ...
 do{
    newStatus = prompt("Обновіть статус замовлення: 1 -- замовлення готується, 2 -- замовлення в дорозі, 3 -- замовлення доставлено, 4 -- схоже щось пішло не там, \n5 -- нічого не міняти: ");
    if (newStatus == '1') {
